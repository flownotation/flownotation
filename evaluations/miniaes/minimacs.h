...
typedef struct _minimacs_
{
   ...
   */
    MR (*lintrans)
    (LinTransID kind, hptr dst, hptr left);
   ...
   */
    MR (*secret_input)
    (uint pid, hptr dst, Data plain_val);
