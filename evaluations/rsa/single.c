...
#param(4) @private_key:secrecy
#return @decode:integrity 
...
int main(void)
{
    #requires @prime:integrity 
    int p;
    #requires @prime:integrity
    int q;
    int n;
    int phi;
    #requires @public_key:secrecy 
    int e;
    #requires @private_key:secrecy 
    int d;
    int bytes;
    int len;
    #requires @encode:integrity
    int* encoded;
    #requires @decode:integrity 
    int* decoded;
    char *buffer;
    FILE *f;
    while (1)
